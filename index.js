...
// app.use(cors({
//   origin: ["http://localhost:5173", "https://mern-react-routing.firebaseapp.com/"]
// }));


// origin: ["http://localhost:5173", "https://idyllic-blini-bef1ca.netlify.app/"]    "https://mern-react-routing.firebaseapp.com/"

const uri = process.env.URI
// `mongodb+srv://${process.env.DB_USER}:${process.env.DB_SECRET}@cluster0.sahfy.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
